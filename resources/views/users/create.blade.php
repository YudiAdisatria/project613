                ...
                <form action="{{ route('users.store') }}" class="w-full" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap"> 
                        <div class="w-full  self-center mt-2 px-3 lg:w-1/2">
                            ...
                            <input value="{{ old('noHp') }}" name="noHp" class="appearance-none block w-full bg-white text-gray-700 border border-gray-100 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="No Handphone">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full  self-center mt-2 px-3 lg:w-1/2">
                            ...
                            <input value="{{ old('divisi') }}" name="divisi" class="appearance-none block w-full bg-white text-gray-700 border border-gray-100 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Divisi User">
                        </div>
                    ...
                    <div class="flex flex-wrap mt-2">
                        <div class="w-full px-3">
                            ...
                            <input name="profile_photo_path" class="appearance-none block w-full bg-white text-gray-700 border border-gray-100 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="file" placeholder="User Image">
                        </div>
                    </div>
