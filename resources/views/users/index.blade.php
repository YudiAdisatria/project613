                ...
                <table class="table-auto w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="border px-6 py-4">Nomor Handphone</th>
                                <th class="border px-6 py-4">Divisi</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border px-6 py-4">{{ $item->noHp }}</td>
                                <td class="border px-6 py-4">{{ $item->divisi }}</td>
