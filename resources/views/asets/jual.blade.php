                ...
                <form action="{{ route('asets.save', $item->id_aset) }}" class="w-full" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap mt-2">
                        ...
                        <div class="w-full  self-center mt-2 px-3 lg:w-1/2">
                            ...
                            <input value="{{ old('harga_jual') ?? $item->harga_jual  }}" name="harga_jual" class="appearance-none block w-full bg-white text-gray-700 border border-gray-100 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="number" min="0" placeholder="harga jual" required>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap mt-2">
                        <div class="w-full px-3">
                            ...
                            <input name="foto_aset" class="appearance-none block w-full bg-white text-gray-700 border border-gray-100 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="file" placeholder="Foto Aset" accept="image/png, image/jpeg">
                        </div>
                    </div>
